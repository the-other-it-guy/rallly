...
<Accordion title="Do I need to create an account to use Rallly?">
  ...
  When you use Rallly without an account, you're using it as a "guest" or "anonymous" user.
  Guest users are assigned a temporary identifier and appear as "Guest" in the application.
  However, some features (like email notifications and saving polls to your dashboard) 
  are only available to users with a registered account. You can convert your guest 
  account to a full account at any time by registering.
</Accordion>
